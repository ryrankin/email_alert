...
const emailAlerts = (err, req, res, next) => {
  if (err instanceof FooError || err instanceof BarError){
    ...
    const emailData = {
      ...
      to: ALERT_TO_EMAIL,
      subject: `MY ALERT: ${err.name}`,
      text: `Something went terribly wrong. All we know is this:\n\n${err.stack} + ${err.message}`,
      html: '<p>This is the body of the html page of the error message that you recieved.</p>'
    };
    sendEmail(emailData);
  }
  next();
